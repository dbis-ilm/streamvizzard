...
4) `expertFlink.py`: The constructed Flink pipeline by an expert user
5) `output_sv.txt`: Example data sink output file for an execution of the StreamVizzard pipeline
6) `output_flink_5para.txt`: Example data sink output file for an execution of the Flink pipeline with a parallelism of 5

...
def main():
    ...
    parser.add_argument('--targetTuples', type=int, default=1000000, required=False, help="The amount of tuples in the output file.")
    parser.add_argument('--timeSeriesLength', type=int, default=5, required=False, help="How many elements should be present inside the time-series per tuple.")
    parser.add_argument('--outputFile', type=str, default="energyData.json", required=False, help="The output file including extension.")
    parser.add_argument('--outlierChance', type=float, default=0.0, required=False, help="The chance for adding a tuple as an outlier.")
    parser.add_argument('--missingValueChance', type=float, default=0.0, required=False, help="The chance to insert a null value for each tuple.")

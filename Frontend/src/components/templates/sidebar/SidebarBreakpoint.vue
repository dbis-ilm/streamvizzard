<template>
  <div class="breakPointEntry">
    ...
    <v-select class="select" :options="selectOptions" :value="selectedValue" label="title" :clearable="false" :searchable="false" @input="_onSelectChanged" style="flex: 1;"></v-select>

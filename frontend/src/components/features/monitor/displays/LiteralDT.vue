...
import SelectDS from "@/components/features/monitor/displays/settings/SelectDS.vue";
  ...
  methods: {
    ...
    getSettingsOptions(props, propsDef) {
      return [{"key": "exp", "name": "Expression", "value": safeVal(props.exp, "$VAL"), "desc": "How to display the value. $VAL signals the value to display. " +
        ...
        {"key": "maxLength", "name": "Max Length", "value": props.maxLength, "desc": "How many characters the display string will have at most", "default": safeVal(propsDef.maxLength), "template": StringDS},
        {"key": "style", "name": "Style", "value": props.style, "desc": "Css style of the display text. Separate multiple values with ';'\nExample: font-weight:bold; font-size:24px;", "default": safeVal(propsDef.style), "template": StringDS},

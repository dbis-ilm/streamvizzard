...
<div :title="desc" class="displayModeSetting">
  ...
  <div class="displayModeSettingOption"><input type="checkbox" v-model="value" @input="onChange($event)" style="float:left; margin-left: 0; margin-top: 2px;"/></div>
...
export default {
  ...
  methods: {
    onChange(e) {
      if(e !== undefined) this.value = e.target.checked;

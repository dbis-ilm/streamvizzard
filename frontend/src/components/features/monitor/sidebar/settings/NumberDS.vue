...
<div :title="desc" class="displayModeSetting">
  ...
  <input type="number" placeholder="Unset" v-model="value" @change="onChange" class="displayModeSettingOption"/>
...
export default {
  ...
  methods: {
    onChange() {
      this.change(this.skey, this.value != null ? parseFloat(this.value) : null);
    },

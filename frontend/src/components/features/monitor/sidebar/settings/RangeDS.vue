...
<div :title="desc" class="displayModeSetting">
  ...
  <input type="number" placeholder="Unset" v-model="val1" @change="onChange" class="displayModeSettingOption"/>&nbsp;
  <input type="number" placeholder="Unset" v-model="val2" @change="onChange" class="displayModeSettingOption"/>

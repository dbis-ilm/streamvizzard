<template>
  <div style="margin-top: 10px;">
    ...
    <div  class="contentContainer">
      ...
      <v-select v-auto-blur class="content alignedSelect" :options="dataOptions" label="title" :value="data" :clearable="false" :searchable="false" @input="_onChange($event)"
                title="(Inv) Normal Dist simulates data used during training of the subsequent operators. Guten Use Custom for own data definitions!"></v-select>
    </div>
